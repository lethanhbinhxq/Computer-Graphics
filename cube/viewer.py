...
def main():
    ...
    # model = Sphere1("./phong_texture.vert", "./phong_texture.frag").setup()
    # model = Sphere2("./phong.vert", "./phong.frag").setup()
    # model = Sphere2("./phong_texture.vert", "./phong_texture.frag").setup()
    # model = Sphere2("./gouraud.vert", "./gouraud.frag").setup()
    # model = Mesh3D("./gouraud.vert", "./gouraud.frag").setup()
    # model = Mesh3D("./phong.vert", "./phong.frag").setup()
    model = Mesh3D("./phong_texture.vert", "./phong_texture.frag").setup()
    # model = Test("./phong.vert", "./phong.frag").setup()
    viewer.add(model)
